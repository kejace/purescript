module MonsterKinds (kind Nat, List(..), Proxy(..), Identity(..), Kinded, Zero, Succ, MySillyNat(..), MySillierNat(..), N0, N1, N2, N3, NatProxy(..), class AddNat, addNat, proxy1, proxy2) where
...
data MySillyNat (t :: Type -> Nat -> Type) (u :: Nat -> Type) (v :: Type) (w :: Nat) = MySillyNat
data MySillierNat (t :: Type -> Nat -> (Type -> Type) -> Nat) = MySillierNat
